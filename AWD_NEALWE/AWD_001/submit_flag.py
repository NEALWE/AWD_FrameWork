...
class flag_sql():
    ...
    def flag_select(self):
        cursor = self.c.execute("select id,flag from AWD_FLAG where submit = 0 and outtime = 0 and julianday('now')*86400-julianday(intime)*86400 < 300 order by id desc;")
        flags = []
        for row in cursor:
            # print "id = ", row[0]
            # print "flag = ", row[1], "\n"
...
if __name__ == "__main__" :
    ...
    cookie = "JSESSIONID=9A36163B311938F971ED14E3DD85611D"
    headers = {
